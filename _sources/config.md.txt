...
documented [here](defaults.html). All paths are relative to the root directory of the project i.e., `$POJECT_HOME`.
...
### `install`
Passed directly to [Travis](https://docs.travis-ci.com/user/customizing-the-build/#Skipping-the-Installation-Step). Used to install packages/software and identical to the use within Travis-CI.

### `credentials`
The file that contains your Github OAuth token. The default is `.credentials`.

### `description`
A user defined description of your repo. This can be as verbose as you deem necessary. e.g. `"A repo that enables Floki to to be cunning"`.